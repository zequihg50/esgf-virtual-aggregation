...
do
    ...
    ncml="${ncmls}/ensemble/{mip_era}/{institution_id}/{mip_era}_{activity_id}_{institution_id}_{source_id}_{experiment_id}_{table_id}_{frequency}_{realm}_{grid_label}_{version}_${version}.ncml"
