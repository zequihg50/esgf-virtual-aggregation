...
PROJECTS = {
    "esgf_dataset": {
        ...
        "dest_replica": "content/public/esgeva/variable/CMIP6/{activity_id}/{table_id}/{mip_era}_{activity_id}_{institution_id}_{source_id}_{experiment_id}_{variant_label}_{table_id}_{grid_label}_{version}/replicas/{data_node}/{mip_era}_{activity_id}_{institution_id}_{source_id}_{experiment_id}_{member_id}_{table_id}_{variable_id}_{grid_label}_{version}_{data_node}.ncml",
        "dest_master": "content/public/esgeva/variable/CMIP6/{activity_id}/{table_id}/{mip_era}_{activity_id}_{institution_id}_{source_id}_{experiment_id}_{variant_label}_{table_id}_{grid_label}_{version}/{mip_era}_{activity_id}_{institution_id}_{source_id}_{experiment_id}_{member_id}_{table_id}_{variable_id}_{grid_label}_{version}_{data_node}.ncml",
    ...
    "esgf_ensemble": {
        ...
        "dest_replica": "content/public/esgeva/ensemble/CMIP6/{activity_id}/{table_id}/{mip_era}_{activity_id}_{institution_id}_{source_id}_{experiment_id}_{table_id}_{grid_label}_{version}/replicas/{data_node}/{mip_era}_{activity_id}_{institution_id}_{source_id}_{experiment_id}_{sub_experiment_id}_{table_id}_{variable_id}_{grid_label}_{version}_{data_node}.ncml",
        "dest_master": "content/public/esgeva/ensemble/CMIP6/{activity_id}/{table_id}/{mip_era}_{activity_id}_{institution_id}_{source_id}_{experiment_id}_{table_id}_{grid_label}_{version}/{mip_era}_{activity_id}_{institution_id}_{source_id}_{experiment_id}_{sub_experiment_id}_{table_id}_{variable_id}_{grid_label}_{version}_{data_node}.ncml",
